import argparse
import re
#TODO: change the information calculation method
# test the accuracy of the information calculation
...
def get_default_parser(num_of_samples=None):
        ...
        parser.add_argument('--conv_net',
                            '-conv', dest="conv_net", type=int, default=0,
                            help='True if we want convnet')
        ...
        parser.add_argument('--calcMethod', '-cm', dest='calcMethod', default='calc_regular_information')
