...
def build_model(activation_function, layerSize, input_size, num_of_classes, learning_rate_local, save_file, conv_net):
...
def train_and_calc_inf_network(i, j, k, layerSize, num_of_epochs, learning_rate_local, batch_size, indexes, save_grads,
                               ...
                               interval_information_display, save_ws, rand_int, conv_net, calcMethod):
        ...
        if calc_information:
                ...
                information = np.array([inn.get_information([network['ws'][-1]], data_sets_org.data, data_sets_org.labels,
                                                            ...
                                                            network['model'], layerSize, calcMethod)])
                network['information'] = information
...
def train_network(layerSize, num_of_epochs, learning_rate_local, batch_size, indexes, save_grads,
        ...
        # Build the network
        model = build_model(model_type, layerSize, input_size, num_of_classes, learning_rate_local, name, conv_net)
